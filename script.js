async function searchBook() {
    ...
    const searchContainer = document.getElementById('searchContainer'); // Ensure this ID matches your HTML
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    searchButton.addEventListener('click', function() {
        // Optionally hide the search input or container
        searchInput.style.display = 'none';
        searchContainer.style.display = 'none'; // Hide the entire search container
    }); 
});
